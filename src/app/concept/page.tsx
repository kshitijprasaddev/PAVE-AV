    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <RevealStack
        ...
        items={[
          ...
          <ul className="mt-6 list-disc pl-6 text-neutral-700 dark:text-neutral-300" key="ul1">
            <li>
              <span className="font-semibold">Demand aware operations</span>: Predict and balance supply where and when it is needed so streets are not oversupplied.
            </li>
            <li>
              <span className="font-semibold">Energy conscious charging</span>: Shift charging to off peak, high renewable periods and avoid local grid stress.
            </li>
            <li>
              <span className="font-semibold">Ride pooling by default</span>: Incentivize pooled trips and micro transit to cut vehicle kilometres traveled.
            </li>
            <li>
              <span className="font-semibold">Public transport first</span>: Integrate with transit for first and last mile links rather than replacing buses or rail.
            </li>
          </ul>,
          <p className="mt-6 text-neutral-700 dark:text-neutral-300" key="p3">
      ...
      <section id="why-ingolstadt" className="mt-10 border-t border-neutral-200 pt-8 dark:border-neutral-800">
        ...
        <RevealStack
          initialDelay={0.08}
          items={[
            <p className="mt-3 text-neutral-700 dark:text-neutral-300" key="p4">
            ...
            <p className="mt-3 text-neutral-700 dark:text-neutral-300" key="p5">
