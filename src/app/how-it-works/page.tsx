  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <ol className="mt-3 list-decimal pl-6 text-neutral-700 dark:text-neutral-300">
        <li><span className="font-semibold">City digital twin</span>: We stream TomTom Route Monitoring telemetry for key corridors (Audi Forum ↔ Hauptbahnhof, Klinikum ↔ Nordbahnhof) and fuse it with municipal charging assets.</li>
        <li><span className="font-semibold">Demand inference</span>: Corridor delay, travel time variance, and land-use priors feed a demand surface rendered as 3D extrusions in deck.gl.</li>
        <li><span className="font-semibold">Fleet agent</span>: A constrained heuristic assigns AV blocks to hotspots, guaranteeing minimum coverage and reserving capacity for first/last-mile connections.</li>
        <li><span className="font-semibold">Energy co-optimisation</span>: Charging windows align with Stadtwerke load curves and rooftop solar peaks; the model recommends V2G buffer opportunities.</li>
      </ol>
