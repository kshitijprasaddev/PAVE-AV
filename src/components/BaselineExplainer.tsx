...
const metrics = [
  ...
  },
  {
    ...
    baseline: "0.60 kWh",
    explanation: "The **baseline** is the current energy cost per ride using diesel buses or inefficient routing. At 0.60 kWh equivalent, this represents today's fleet. The RL optimizer tests when to charge vehicles (off-peak vs peak hours) and how to route them efficiently. If energy drops to 0.48 kWh, you save **0.12 kWh per ride**, which scales to millions in annual savings across a city fleet.",
